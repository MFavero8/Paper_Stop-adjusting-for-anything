...
data.frame(colA = c('Research question', rep('Assumptions', 6), rep('Variables', 5)),
           colB = c('Total average causal effect (ACE) of social interaction (I) on glare perception (G).',
                    ...
                    'CO2 concentration (H): continuous variable [unit: ppm]',
...
We can also visualize all the 1,000 estimates of the coefficient for social interaction for `Model.1`, `Model.2` and `Model.3` (the estimates were shown as white dots in @fig-DAG.ex2-CI).
