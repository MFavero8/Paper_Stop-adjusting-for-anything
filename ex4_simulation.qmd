...
data.frame(colA = c('Research question', rep('Assumptions', 6), rep('Variables', 4)),
           colB = c('Total average causal effect (ACE) of microbial aerosol (M) on respiratory irritation (R).',
